...
class testcase_bs_PosWork_savePosWorkChange_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosWork_savePosWorkChange(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","htlDate":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","periodId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"unitUid":"","workStationId":0}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosWork/savePosWorkChange",jsondump_params, headers)

            #response is HTTPResponse Object
            response = self.httpClient.getresponse()
            print response.reason
            APIreponstr = response.read()
            dbResponsejsonStr={"endTm":"","periodCd":"","periodFlg":"","periodId":0,"periodNm":"","responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""},"startTm":""}
