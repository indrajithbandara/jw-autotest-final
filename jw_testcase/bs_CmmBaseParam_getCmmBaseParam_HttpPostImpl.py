...
class testcase_bs_CmmBaseParam_getCmmBaseParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmBaseParam_getCmmBaseParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmBaseParam/getCmmBaseParam",jsondump_params, headers)
