...
class testcase_bs_PlfPrdtPerms_delPlfPrdtPerms_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtPerms_delPlfPrdtPerms(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtPerms/delPlfPrdtPerms",jsondump_params, headers)
