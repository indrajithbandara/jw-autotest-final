...
class testcase_bs_PosSales_listGetCanUse_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosSales_listGetCanUse(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","hotelCd":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"userID":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosSales/listGetCanUse",jsondump_params, headers)
