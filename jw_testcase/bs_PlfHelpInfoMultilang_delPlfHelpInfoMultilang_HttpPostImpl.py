...
class testcase_bs_PlfHelpInfoMultilang_delPlfHelpInfoMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpInfoMultilang_delPlfHelpInfoMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpInfoMultilang/delPlfHelpInfoMultilang",jsondump_params, headers)
