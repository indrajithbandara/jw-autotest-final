...
class testcase_bs_PosWork_getPosWork_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosWork_getPosWork(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosWork/getPosWork",jsondump_params, headers)
