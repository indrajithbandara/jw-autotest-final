...
class testcase_bs_CmmBaseParam_updateCmmBaseParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmBaseParam_updateCmmBaseParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmBaseParam/updateCmmBaseParam",jsondump_params, headers)
