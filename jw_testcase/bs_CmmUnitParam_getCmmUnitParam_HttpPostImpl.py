...
class testcase_bs_CmmUnitParam_getCmmUnitParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmUnitParam_getCmmUnitParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmUnitParam/getCmmUnitParam",jsondump_params, headers)
