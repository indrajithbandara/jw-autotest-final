...
class testcase_bs_GrpHkUnitRoomtype_delIdsGrpHkUnitRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkUnitRoomtype_delIdsGrpHkUnitRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkUnitRoomtype/delIdsGrpHkUnitRoomtype",jsondump_params, headers)
