...
class testcase_bs_PlfHelpInfoMultilang_queryPlfHelpInfoMultilangList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpInfoMultilang_queryPlfHelpInfoMultilangList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"currentPage":0,"displayData":"","helpCd":"","helpDrpt":"","helpId":0,"helpTyp":"","id":0,"languageId":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","orderColumn":[],"pageSize":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpInfoMultilang/queryPlfHelpInfoMultilangList",jsondump_params, headers)
