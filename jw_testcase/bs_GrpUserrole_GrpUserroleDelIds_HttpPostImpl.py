...
class testcase_bs_GrpUserrole_GrpUserroleDelIds_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpUserrole_GrpUserroleDelIds(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpUserrole/GrpUserroleDelIds",jsondump_params, headers)
