...
class testcase_bs_PosPeriod_savePosPeriod_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosPeriod_savePosPeriod(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosPeriod/savePosPeriod",jsondump_params, headers)
