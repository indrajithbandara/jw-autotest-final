...
class testcase_bs_3140010_PlfPdtPermstyp_updateData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfPdtPermstyp_updateData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfPdtPermstyp/updateData",jsondump_params, headers)
