...
class testcase_bs_3520010_GrpCrmCorp_delete_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorp_delete(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorp/delete",jsondump_params, headers)
