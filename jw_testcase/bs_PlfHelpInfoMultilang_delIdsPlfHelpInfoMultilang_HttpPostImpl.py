...
class testcase_bs_PlfHelpInfoMultilang_delIdsPlfHelpInfoMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpInfoMultilang_delIdsPlfHelpInfoMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpInfoMultilang/delIdsPlfHelpInfoMultilang",jsondump_params, headers)
