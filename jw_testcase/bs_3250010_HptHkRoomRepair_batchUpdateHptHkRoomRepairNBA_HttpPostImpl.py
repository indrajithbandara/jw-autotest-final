...
class testcase_bs_3250010_HptHkRoomRepair_batchUpdateHptHkRoomRepairNBA_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptHkRoomRepair_batchUpdateHptHkRoomRepairNBA(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptHkRoomRepair/batchUpdateHptHkRoomRepairNBA",jsondump_params, headers)
