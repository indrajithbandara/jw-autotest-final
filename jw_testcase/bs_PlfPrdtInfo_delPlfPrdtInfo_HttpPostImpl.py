...
class testcase_bs_PlfPrdtInfo_delPlfPrdtInfo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtInfo_delPlfPrdtInfo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtInfo/delPlfPrdtInfo",jsondump_params, headers)
