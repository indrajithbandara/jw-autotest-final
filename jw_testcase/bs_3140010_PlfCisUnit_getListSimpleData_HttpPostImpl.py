...
class testcase_bs_3140010_PlfCisUnit_getListSimpleData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfCisUnit_getListSimpleData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","orderColumn":[],"pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":"","unitCd":"","unitDrpt":"","unitFlg":"","unitNm":"","unitTyp":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfCisUnit/getListSimpleData",jsondump_params, headers)
