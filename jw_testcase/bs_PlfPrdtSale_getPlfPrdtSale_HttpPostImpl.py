...
class testcase_bs_PlfPrdtSale_getPlfPrdtSale_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtSale_getPlfPrdtSale(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtSale/getPlfPrdtSale",jsondump_params, headers)
