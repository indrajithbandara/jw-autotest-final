...
class testcase_bs_PlfCmmConfigMultilang_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmConfigMultilang_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","id":0,"languageId":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","note":"","orderColumn":[],"pageLength":"","pageStart":"","paramDrpt":"","paramId":0,"paramStr1":"","paramStr10":"","paramStr2":"","paramStr3":"","paramStr4":"","paramStr5":"","paramStr6":"","paramStr7":"","paramStr8":"","paramStr9":"","paramTyp":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"statusFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmConfigMultilang/listGetData",jsondump_params, headers)
