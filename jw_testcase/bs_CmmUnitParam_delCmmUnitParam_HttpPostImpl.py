...
class testcase_bs_CmmUnitParam_delCmmUnitParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmUnitParam_delCmmUnitParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmUnitParam/delCmmUnitParam",jsondump_params, headers)
