...
class testcase_bs_3250010_HptPmsRoomCombo_delIdsHptPmsRoomCombo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsRoomCombo_delIdsHptPmsRoomCombo(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","ids":[],"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","userUid":"","validReqDtoStatus":""}}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsRoomCombo/delIdsHptPmsRoomCombo",jsondump_params, headers)

            #response is HTTPResponse Object
            response = self.httpClient.getresponse()
            print response.reason
            reponstr = response.read()
            responsejsonStr={"responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""}}
