...
class testcase_bs_GrpHkBaseRoomtype_saveGrpHkBaseRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkBaseRoomtype_saveGrpHkBaseRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkBaseRoomtype/saveGrpHkBaseRoomtype",jsondump_params, headers)
