...
class testcase_bs_GrpCmmOption_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCmmOption_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","displayData":"","enableFlg":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","optionCd":"","optionDrpt":"","optionDt1":"","optionDt2":"","optionDt3":"","optionDt4":"","optionDt5":"","optionNum1":0,"optionNum2":0,"optionNum3":0,"optionNum4":0,"optionNum5":0,"optionStr1":"","optionStr2":"","optionStr3":"","optionStr4":"","optionStr5":"","optionVlu":"","orderColumn":[],"pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"sysid":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCmmOption/listGetData",jsondump_params, headers)
