...
class testcase_bs_RsvHouseblock_delRsvHouseblock_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvHouseblock_delRsvHouseblock(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvHouseblock/delRsvHouseblock",jsondump_params, headers)
