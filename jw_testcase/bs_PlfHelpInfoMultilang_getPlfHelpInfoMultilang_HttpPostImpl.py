...
class testcase_bs_PlfHelpInfoMultilang_getPlfHelpInfoMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpInfoMultilang_getPlfHelpInfoMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpInfoMultilang/getPlfHelpInfoMultilang",jsondump_params, headers)
