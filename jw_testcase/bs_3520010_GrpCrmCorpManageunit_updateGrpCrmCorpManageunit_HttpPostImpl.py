...
class testcase_bs_3520010_GrpCrmCorpManageunit_updateGrpCrmCorpManageunit_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpManageunit_updateGrpCrmCorpManageunit(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpManageunit/updateGrpCrmCorpManageunit",jsondump_params, headers)
