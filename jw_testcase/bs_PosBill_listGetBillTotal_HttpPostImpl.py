...
class testcase_bs_PosBill_listGetBillTotal_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBill_listGetBillTotal(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","hotelDt":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","pageLength":"","pageStart":"","periodId":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBill/listGetBillTotal",jsondump_params, headers)
