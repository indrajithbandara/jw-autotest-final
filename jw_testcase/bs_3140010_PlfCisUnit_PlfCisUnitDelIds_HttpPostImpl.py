...
class testcase_bs_3140010_PlfCisUnit_PlfCisUnitDelIds_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfCisUnit_PlfCisUnitDelIds(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfCisUnit/PlfCisUnitDelIds",jsondump_params, headers)
