...
class testcase_bs_3510010_GrpCrmProfileContactway_saveData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfileContactway_saveData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfileContactway/saveData",jsondump_params, headers)
