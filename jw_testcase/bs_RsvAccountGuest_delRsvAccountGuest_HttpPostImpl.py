...
class testcase_bs_RsvAccountGuest_delRsvAccountGuest_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccountGuest_delRsvAccountGuest(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccountGuest/delRsvAccountGuest",jsondump_params, headers)
