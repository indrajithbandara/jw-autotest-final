...
class testcase_bs_GrpCmmEmployee_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCmmEmployee_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","deptId":0,"displayData":"","employeeAltnm":"","employeeCd":"","employeeId":0,"employeeNm":"","employeePositionId":0,"employeeTyp":"","employeeWorktitleId":0,"id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","onjobFlg":"","orderColumn":[],"pageLength":"","pageStart":"","profileNo":"","requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":"","unitUid":"","userUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCmmEmployee/listGetData",jsondump_params, headers)
