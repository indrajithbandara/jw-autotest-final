...
class testcase_bs_3520010_GrpCrmCorpManageunit_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpManageunit_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","commId":0,"contractFlg":"","corpClsId":0,"corpGrpId":0,"corpLvId":0,"corpNo":"","corpSubclsId":0,"currentPage":0,"defaultFlg":"","displayData":"","fastquery":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"marketId":0,"mntUnitUid":"","note":"","orderColumn":[],"pageSize":0,"potentialFlg":"","potentialTypId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salerUid":"","seq":0,"sourceId":0,"statusFlg":"","subIds":[]}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpManageunit/listGetData",jsondump_params, headers)
