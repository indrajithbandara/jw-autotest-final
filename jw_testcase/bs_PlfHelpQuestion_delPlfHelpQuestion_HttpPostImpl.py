...
class testcase_bs_PlfHelpQuestion_delPlfHelpQuestion_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpQuestion_delPlfHelpQuestion(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpQuestion/delPlfHelpQuestion",jsondump_params, headers)
