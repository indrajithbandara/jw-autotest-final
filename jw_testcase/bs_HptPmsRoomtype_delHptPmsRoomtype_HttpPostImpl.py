...
class testcase_bs_HptPmsRoomtype_delHptPmsRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_HptPmsRoomtype_delHptPmsRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/HptPmsRoomtype/delHptPmsRoomtype",jsondump_params, headers)
