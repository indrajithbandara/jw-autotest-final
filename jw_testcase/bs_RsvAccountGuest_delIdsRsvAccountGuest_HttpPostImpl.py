...
class testcase_bs_RsvAccountGuest_delIdsRsvAccountGuest_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccountGuest_delIdsRsvAccountGuest(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccountGuest/delIdsRsvAccountGuest",jsondump_params, headers)
