...
class testcase_bs_PlfPrdtInfo_savePlfPrdtInfo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtInfo_savePlfPrdtInfo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtInfo/savePlfPrdtInfo",jsondump_params, headers)
