...
class testcase_bs_PosBlock_delIdsPosBlock_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlock_delIdsPosBlock(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlock/delIdsPosBlock",jsondump_params, headers)
