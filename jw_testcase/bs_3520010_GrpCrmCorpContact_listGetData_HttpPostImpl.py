...
class testcase_bs_3520010_GrpCrmCorpContact_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpContact_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"currentPage":0,"displayData":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"pageSize":0,"queryString":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"subIds":[]}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpContact/listGetData",jsondump_params, headers)
