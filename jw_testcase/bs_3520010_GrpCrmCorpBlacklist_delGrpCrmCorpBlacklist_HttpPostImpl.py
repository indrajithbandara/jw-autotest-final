...
class testcase_bs_3520010_GrpCrmCorpBlacklist_delGrpCrmCorpBlacklist_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpBlacklist_delGrpCrmCorpBlacklist(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpBlacklist/delGrpCrmCorpBlacklist",jsondump_params, headers)
