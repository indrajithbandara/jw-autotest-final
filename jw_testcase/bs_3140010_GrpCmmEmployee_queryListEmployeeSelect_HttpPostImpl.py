...
class testcase_bs_3140010_GrpCmmEmployee_queryListEmployeeSelect_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpCmmEmployee_queryListEmployeeSelect(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","currentPage":0,"deptId":0,"displayData":"","employeeAltnm":"","employeeCd":"","employeeId":0,"employeeNm":"","employeePositionId":0,"employeeTyp":"","employeeWorktitleId":0,"id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","onjobFlg":"","orderColumn":[],"pageLength":"","pageSize":0,"pageStart":"","profileNo":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":"","unitUid":"","userUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpCmmEmployee/queryListEmployeeSelect",jsondump_params, headers)

            #response is HTTPResponse Object
            response = self.httpClient.getresponse()
            print response.reason
            APIreponstr = response.read()
            dbResponsejsonStr={"responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""},"responseDto":[]}
