...
class testcase_bs_PlfHelpAnswer_savePlfHelpAnswer_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpAnswer_savePlfHelpAnswer(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpAnswer/savePlfHelpAnswer",jsondump_params, headers)
