...
class testcase_bs_RsvHouseblock_saveRsvHouseblock_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvHouseblock_saveRsvHouseblock(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvHouseblock/saveRsvHouseblock",jsondump_params, headers)
