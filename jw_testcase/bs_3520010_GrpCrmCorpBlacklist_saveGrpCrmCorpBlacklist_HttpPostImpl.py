...
class testcase_bs_3520010_GrpCrmCorpBlacklist_saveGrpCrmCorpBlacklist_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpBlacklist_saveGrpCrmCorpBlacklist(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpBlacklist/saveGrpCrmCorpBlacklist",jsondump_params, headers)
