...
class testcase_${inter_name}_httppostImpl(unittest.TestCase):
    ...
    def test_${inter_name}(self):
            ...
            for i in dictstr:
                ...
                #self.assertEqual(str(apireponstr).find(str(i)), -1);
                #if str(dbResponsejsonStr).find(str(i)) == -1:
                    # print "No filed String in reponse json string here!",dictstr[i]
                    # raise Exception("........No filed in reponse string here",dictstr[i])
                #else:
                if (str(apireponstr).find(str(i))!=-1):
                    print " $$$$$$$$$$$$$$$$$$$$$$db repose string is not match calling api repose string$$$$$$$$$$$$$$$$$ ."
                    self.assertEqual(str(apireponstr).find(str(i)), -1);
                    #pass
                else:
                    print "Found it now.awesome! ' field str inclued ' in the string.",str(apireponstr).find("responseCommonDto")>1
                    if (str(apireponstr).find("responseCommonDto")!=-1):
                        ...
                        if (len(messageCodeStr) == 6 and messageCodeStr == "000000" and  (statucode==200 or statucode==201)):
                         ...
                         print " I can not find responseCommonDto !!!!!!!!!!!!!!!!!!!!!!!!!!!",str(dbResponsejsonStr).find("responseCommonDto")
                         self.assertEqual(str(apireponstr).find("responseCommonDto"), -1);
