...
class testcase_bs_RsvAccountRate_delRsvAccountRate_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccountRate_delRsvAccountRate(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccountRate/delRsvAccountRate",jsondump_params, headers)
