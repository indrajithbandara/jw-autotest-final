...
class testcase_bs_PlfCmmParameter_savePlfCmmParameter_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmParameter_savePlfCmmParameter(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmParameter/savePlfCmmParameter",jsondump_params, headers)
