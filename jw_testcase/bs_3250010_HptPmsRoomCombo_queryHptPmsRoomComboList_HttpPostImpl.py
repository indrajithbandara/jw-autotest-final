...
class testcase_bs_3250010_HptPmsRoomCombo_queryHptPmsRoomComboList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsRoomCombo_queryHptPmsRoomComboList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"areaUtilized":0,"chainUid":"","comboFlg":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","orderColumn":[],"pageLength":"","pageStart":"","percentUtilized":0,"primaryRoomNum":"","requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","userUid":"","validReqDtoStatus":""},"roomNum":"","statusFlg":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsRoomCombo/queryHptPmsRoomComboList",jsondump_params, headers)
