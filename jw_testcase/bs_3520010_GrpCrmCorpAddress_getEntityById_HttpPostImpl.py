...
class testcase_bs_3520010_GrpCrmCorpAddress_getEntityById_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpAddress_getEntityById(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpAddress/getEntityById",jsondump_params, headers)
