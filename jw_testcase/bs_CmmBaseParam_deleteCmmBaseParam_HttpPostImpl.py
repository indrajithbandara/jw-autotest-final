...
class testcase_bs_CmmBaseParam_deleteCmmBaseParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmBaseParam_deleteCmmBaseParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmBaseParam/deleteCmmBaseParam",jsondump_params, headers)
