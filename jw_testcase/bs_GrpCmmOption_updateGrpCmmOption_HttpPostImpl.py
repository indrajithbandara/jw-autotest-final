...
class testcase_bs_GrpCmmOption_updateGrpCmmOption_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCmmOption_updateGrpCmmOption(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCmmOption/updateGrpCmmOption",jsondump_params, headers)
