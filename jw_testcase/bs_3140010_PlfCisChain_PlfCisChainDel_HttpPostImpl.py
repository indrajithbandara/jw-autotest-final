...
class testcase_bs_3140010_PlfCisChain_PlfCisChainDel_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfCisChain_PlfCisChainDel(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfCisChain/PlfCisChainDel",jsondump_params, headers)
