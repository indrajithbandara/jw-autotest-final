...
class testcase_bs_RsvAccount_saveRsvAccount_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccount_saveRsvAccount(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccount/saveRsvAccount",jsondump_params, headers)
