...
class testcase_bs_3140010_GrpCmmSaler_delGrpCmmSaler_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpCmmSaler_delGrpCmmSaler(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpCmmSaler/delGrpCmmSaler",jsondump_params, headers)
