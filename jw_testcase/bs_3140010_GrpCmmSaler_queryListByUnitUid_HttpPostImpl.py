...
class testcase_bs_3140010_GrpCmmSaler_queryListByUnitUid_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpCmmSaler_queryListByUnitUid(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","checkgrps2Id":0,"checkgrpsId":0,"checksalersId":0,"displayData":"","employeeId":0,"employeeNm":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","managerFlg":"","orderColumn":[],"pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salerId":0,"salerIds":[],"salergrp2Id":0,"salergrpId":0,"seq":0,"statusFlg":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpCmmSaler/queryListByUnitUid",jsondump_params, headers)
