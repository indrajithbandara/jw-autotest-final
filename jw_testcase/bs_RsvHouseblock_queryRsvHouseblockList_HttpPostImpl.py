...
class testcase_bs_RsvHouseblock_queryRsvHouseblockList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvHouseblock_queryRsvHouseblockList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"adultCnt":0,"areaId":"","arrDt":"","arrStus":"","blockFlg":"","blockKey":"","blockQuant":0,"blockStus":"","businessDt":"","chainUid":"","channelNo":"","childCnt":0,"clockrmFlg":"","cohuFlg":"","currentPage":0,"definiteFlg":"","displayData":"","dptDt":"","dptStus":"","earlyinFlg":"","fromTm":"","grpNo":"","id":0,"igFlg":"","lateoutFlg":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","maleCnt":0,"marketId":0,"negoCorpNo":"","orderColumn":[],"pageSize":0,"repairSeq":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"resvNo":"","roomNum":"","roomQuant":0,"roomfixFlg":"","roomtypId":0,"rtAmt":0,"salerId":0,"scityId":0,"scountryId":0,"shareSeq":"","shareStus":"","sourceId":0,"sprovinceId":0,"toTm":"","unitUid":"","vipFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvHouseblock/queryRsvHouseblockList",jsondump_params, headers)
