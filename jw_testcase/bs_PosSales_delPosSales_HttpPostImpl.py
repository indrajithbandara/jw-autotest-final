...
class testcase_bs_PosSales_delPosSales_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosSales_delPosSales(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosSales/delPosSales",jsondump_params, headers)
