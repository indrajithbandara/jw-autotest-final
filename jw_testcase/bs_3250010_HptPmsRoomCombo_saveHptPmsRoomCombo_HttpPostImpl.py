...
class testcase_bs_3250010_HptPmsRoomCombo_saveHptPmsRoomCombo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsRoomCombo_saveHptPmsRoomCombo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsRoomCombo/saveHptPmsRoomCombo",jsondump_params, headers)
