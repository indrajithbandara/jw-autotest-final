...
class testcase_bs_3250010_HptPmsRoom_cleanHptRoom_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsRoom_cleanHptRoom(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsRoom/cleanHptRoom",jsondump_params, headers)
