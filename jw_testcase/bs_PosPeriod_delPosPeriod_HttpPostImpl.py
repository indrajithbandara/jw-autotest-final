...
class testcase_bs_PosPeriod_delPosPeriod_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosPeriod_delPosPeriod(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosPeriod/delPosPeriod",jsondump_params, headers)
