...
class testcase_bs_PosPeriod_delIdsPosPeriod_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosPeriod_delIdsPosPeriod(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosPeriod/delIdsPosPeriod",jsondump_params, headers)
