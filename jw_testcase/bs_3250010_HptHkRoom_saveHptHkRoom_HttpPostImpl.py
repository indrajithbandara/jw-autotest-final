...
class testcase_bs_3250010_HptHkRoom_saveHptHkRoom_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptHkRoom_saveHptHkRoom(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptHkRoom/saveHptHkRoom",jsondump_params, headers)
