...
class testcase_bs_HptPmsRoomtype_getHptPmsRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_HptPmsRoomtype_getHptPmsRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/HptPmsRoomtype/getHptPmsRoomtype",jsondump_params, headers)
