...
class testcase_bs_CmmPosParam_delIdsCmmPosParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParam_delIdsCmmPosParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParam/delIdsCmmPosParam",jsondump_params, headers)
