...
class testcase_bs_PlfCmmConfigMultilang_delIdsPlfCmmConfigMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmConfigMultilang_delIdsPlfCmmConfigMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmConfigMultilang/delIdsPlfCmmConfigMultilang",jsondump_params, headers)
