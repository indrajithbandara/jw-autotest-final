...
class testcase_bs_GrpRolePermission_getGrpRolePermission_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpRolePermission_getGrpRolePermission(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpRolePermission/getGrpRolePermission",jsondump_params, headers)
