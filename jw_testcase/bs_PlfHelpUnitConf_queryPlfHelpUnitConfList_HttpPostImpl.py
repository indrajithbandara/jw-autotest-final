...
class testcase_bs_PlfHelpUnitConf_queryPlfHelpUnitConfList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpUnitConf_queryPlfHelpUnitConfList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","currentPage":0,"displayData":"","helpId":0,"id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","orderColumn":[],"pageCd":"","pageFieldCd":"","pageFieldId":0,"pageId":0,"pageSize":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"statusFlg":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpUnitConf/queryPlfHelpUnitConfList",jsondump_params, headers)
