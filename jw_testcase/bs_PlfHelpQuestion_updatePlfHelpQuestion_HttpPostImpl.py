...
class testcase_bs_PlfHelpQuestion_updatePlfHelpQuestion_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpQuestion_updatePlfHelpQuestion(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpQuestion/updatePlfHelpQuestion",jsondump_params, headers)
