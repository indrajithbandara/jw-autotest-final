...
class testcase_bs_3540010_GrpCrmMember_getGrpCrmSimpleMember_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3540010_GrpCrmMember_getGrpCrmSimpleMember(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3540010/GrpCrmMember/getGrpCrmSimpleMember",jsondump_params, headers)

            #response is HTTPResponse Object
            response = self.httpClient.getresponse()
            print response.reason
            APIreponstr = response.read()
            dbResponsejsonStr={"responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""},"resultData":{"id":0,"loginCd":"","loginPwd":"","profileNo":"","version":0}}
