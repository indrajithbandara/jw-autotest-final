...
class testcase_bs_3140010_GrpUser_getListData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpUser_getListData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","displayData":"","languageCd":"","languageId":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","orderColumn":[],"pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"statusFlg":"","unitUid":"","userCd":"","userFlg":"","userNm":"","userPwd":"","userUid":"","version":0}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpUser/getListData",jsondump_params, headers)
