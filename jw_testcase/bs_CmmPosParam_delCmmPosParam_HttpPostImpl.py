...
class testcase_bs_CmmPosParam_delCmmPosParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParam_delCmmPosParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParam/delCmmPosParam",jsondump_params, headers)
