...
class testcase_bs_PlfCmmConfig_delPlfCmmConfig_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmConfig_delPlfCmmConfig(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmConfig/delPlfCmmConfig",jsondump_params, headers)
