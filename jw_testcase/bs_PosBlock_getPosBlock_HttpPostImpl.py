...
class testcase_bs_PosBlock_getPosBlock_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlock_getPosBlock(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlock/getPosBlock",jsondump_params, headers)
