...
class testcase_bs_RsvAccountGuest_getRsvAccountGuest_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccountGuest_getRsvAccountGuest(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccountGuest/getRsvAccountGuest",jsondump_params, headers)
