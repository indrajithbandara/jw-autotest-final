...
class testcase_bs_PosSales_getPosSales_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosSales_getPosSales(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosSales/getPosSales",jsondump_params, headers)
