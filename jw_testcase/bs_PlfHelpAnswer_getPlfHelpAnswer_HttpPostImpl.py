...
class testcase_bs_PlfHelpAnswer_getPlfHelpAnswer_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpAnswer_getPlfHelpAnswer(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpAnswer/getPlfHelpAnswer",jsondump_params, headers)
