...
class testcase_bs_PosBill_delIdsPosBill_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBill_delIdsPosBill(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBill/delIdsPosBill",jsondump_params, headers)
