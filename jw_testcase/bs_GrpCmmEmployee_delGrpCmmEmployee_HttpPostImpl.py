...
class testcase_bs_GrpCmmEmployee_delGrpCmmEmployee_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCmmEmployee_delGrpCmmEmployee(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCmmEmployee/delGrpCmmEmployee",jsondump_params, headers)
