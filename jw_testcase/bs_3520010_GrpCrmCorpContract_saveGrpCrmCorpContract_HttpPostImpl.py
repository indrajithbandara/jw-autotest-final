...
class testcase_bs_3520010_GrpCrmCorpContract_saveGrpCrmCorpContract_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpContract_saveGrpCrmCorpContract(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpContract/saveGrpCrmCorpContract",jsondump_params, headers)
