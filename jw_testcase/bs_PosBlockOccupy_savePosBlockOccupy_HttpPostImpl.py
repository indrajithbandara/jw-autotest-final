...
class testcase_bs_PosBlockOccupy_savePosBlockOccupy_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlockOccupy_savePosBlockOccupy(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlockOccupy/savePosBlockOccupy",jsondump_params, headers)
