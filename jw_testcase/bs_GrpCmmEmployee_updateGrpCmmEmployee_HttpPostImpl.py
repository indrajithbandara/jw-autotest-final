...
class testcase_bs_GrpCmmEmployee_updateGrpCmmEmployee_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCmmEmployee_updateGrpCmmEmployee(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCmmEmployee/updateGrpCmmEmployee",jsondump_params, headers)
