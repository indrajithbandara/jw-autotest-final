...
class testcase_bs_3250010_HptHkRoomRepair_batchSaveHptHkRoomRepairNBA_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptHkRoomRepair_batchSaveHptHkRoomRepairNBA(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptHkRoomRepair/batchSaveHptHkRoomRepairNBA",jsondump_params, headers)
