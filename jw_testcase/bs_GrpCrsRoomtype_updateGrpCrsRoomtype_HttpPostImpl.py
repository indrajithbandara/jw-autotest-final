...
class testcase_bs_GrpCrsRoomtype_updateGrpCrsRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCrsRoomtype_updateGrpCrsRoomtype(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","logAbstractInfo":"","logInfoDto":"","originData":{"chainUid":"","combinationFlg":"","id":0,"meetingroomFlg":"","note":"","pseudoFlg":"","responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""},"roomtypCd":"","roomtypId":0,"roomtypNm":"","seq":0,"shareableFlg":"","statusFlg":"","suitFlg":"","version":0},"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"submitData":{"chainUid":"","combinationFlg":"","id":0,"meetingroomFlg":"","note":"","pseudoFlg":"","responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""},"roomtypCd":"","roomtypId":0,"roomtypNm":"","seq":0,"shareableFlg":"","statusFlg":"","suitFlg":"","version":0}}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCrsRoomtype/updateGrpCrsRoomtype",jsondump_params, headers)

            #response is HTTPResponse Object
            response = self.httpClient.getresponse()
            print response.reason
            APIreponstr = response.read()
            dbResponsejsonStr={"responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""},"resultData":{"chainUid":"","combinationFlg":"","id":0,"meetingroomFlg":"","note":"","pseudoFlg":"","responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""},"roomtypCd":"","roomtypId":0,"roomtypNm":"","seq":0,"shareableFlg":"","statusFlg":"","suitFlg":"","version":0}}
