...
if __name__ == '__main__':
    ...
    for inter_row in interdef_result:
        ...
        generateNewCode.httpPostApiMethod(inter_name,inter_url,requestjson,responsejson,inter_type,jw_interface_reqip,jw_interface_reqport,inter_chinaname)
