...
class testcase_bs_PlfHelpConf_delIdsPlfHelpConf_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpConf_delIdsPlfHelpConf(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpConf/delIdsPlfHelpConf",jsondump_params, headers)
