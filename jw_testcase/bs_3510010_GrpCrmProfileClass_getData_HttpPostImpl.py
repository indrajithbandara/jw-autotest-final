...
class testcase_bs_3510010_GrpCrmProfileClass_getData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfileClass_getData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfileClass/getData",jsondump_params, headers)
