...
class testcase_bs_3140010_GrpCmmEmployee_delGrpCmmEmployee_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpCmmEmployee_delGrpCmmEmployee(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpCmmEmployee/delGrpCmmEmployee",jsondump_params, headers)
