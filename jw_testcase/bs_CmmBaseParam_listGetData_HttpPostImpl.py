...
class testcase_bs_CmmBaseParam_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmBaseParam_listGetData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmBaseParam/listGetData",jsondump_params, headers)
