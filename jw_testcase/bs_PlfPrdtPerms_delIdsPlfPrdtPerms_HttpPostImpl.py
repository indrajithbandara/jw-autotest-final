...
class testcase_bs_PlfPrdtPerms_delIdsPlfPrdtPerms_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtPerms_delIdsPlfPrdtPerms(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtPerms/delIdsPlfPrdtPerms",jsondump_params, headers)
