...
class testcase_bs_PlfHelpInfoMultilang_savePlfHelpInfoMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpInfoMultilang_savePlfHelpInfoMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpInfoMultilang/savePlfHelpInfoMultilang",jsondump_params, headers)
