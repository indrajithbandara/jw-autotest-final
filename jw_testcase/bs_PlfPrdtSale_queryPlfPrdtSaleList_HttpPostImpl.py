...
class testcase_bs_PlfPrdtSale_queryPlfPrdtSaleList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtSale_queryPlfPrdtSaleList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"beginDate":"","chainUid":"","currentPage":0,"displayData":"","endDate":"","id":0,"isUseContinued":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","orderColumn":[],"pageSize":0,"prdtCd":"","prdtId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtSale/queryPlfPrdtSaleList",jsondump_params, headers)
