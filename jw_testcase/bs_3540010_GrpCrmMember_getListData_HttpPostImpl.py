...
class testcase_bs_3540010_GrpCrmMember_getListData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3540010_GrpCrmMember_getListData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"certificate_idcd":"","certificatetypId":0,"chainUid":"","currentPage":0,"displayData":"","email":"","fastQuery":"","id":0,"ids":[],"joinDate":"","jointypId":0,"languageId":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","loginCd":"","memberStat":"","memberrankId":0,"membertypId":0,"orderColumn":[],"pageSize":0,"phone":"","primaryFlg":"","profileNo":"","quitDate":"","referorg":"","referrer":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salerId":0,"statusFlg":"","unitUid":"","validedDate":"","validstDate":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3540010/GrpCrmMember/getListData",jsondump_params, headers)
