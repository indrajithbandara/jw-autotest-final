...
class testcase_bs_GrpRolePermission_GrpRolePermissionDel_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpRolePermission_GrpRolePermissionDel(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpRolePermission/GrpRolePermissionDel",jsondump_params, headers)
