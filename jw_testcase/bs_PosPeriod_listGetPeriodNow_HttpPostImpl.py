...
class testcase_bs_PosPeriod_listGetPeriodNow_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosPeriod_listGetPeriodNow(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","hotelDt":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosPeriod/listGetPeriodNow",jsondump_params, headers)
