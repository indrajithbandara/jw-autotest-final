...
class testcase_bs_PosBlockOccupy_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlockOccupy_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"blockCd":"","blockId":0,"chainUid":"","closeBy":"","closeByCd":"","closeByUid":"","closeDate":"","closePeriod":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","occupyFlg":"","occupyId":0,"openBy":"","openByCd":"","openByUid":"","openDate":"","openPeriod":"","orderColumn":[],"pageLength":"","pageStart":"","relationId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"unitUid":"","validFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlockOccupy/listGetData",jsondump_params, headers)
