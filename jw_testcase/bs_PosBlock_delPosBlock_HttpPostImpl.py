...
class testcase_bs_PosBlock_delPosBlock_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlock_delPosBlock(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlock/delPosBlock",jsondump_params, headers)
