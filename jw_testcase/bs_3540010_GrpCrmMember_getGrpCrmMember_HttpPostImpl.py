...
class testcase_bs_3540010_GrpCrmMember_getGrpCrmMember_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3540010_GrpCrmMember_getGrpCrmMember(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3540010/GrpCrmMember/getGrpCrmMember",jsondump_params, headers)
