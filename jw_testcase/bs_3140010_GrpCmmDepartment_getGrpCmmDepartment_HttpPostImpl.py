...
class testcase_bs_3140010_GrpCmmDepartment_getGrpCmmDepartment_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpCmmDepartment_getGrpCmmDepartment(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpCmmDepartment/getGrpCmmDepartment",jsondump_params, headers)
