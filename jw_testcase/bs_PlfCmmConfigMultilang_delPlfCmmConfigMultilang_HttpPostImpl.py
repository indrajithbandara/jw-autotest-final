...
class testcase_bs_PlfCmmConfigMultilang_delPlfCmmConfigMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmConfigMultilang_delPlfCmmConfigMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmConfigMultilang/delPlfCmmConfigMultilang",jsondump_params, headers)
