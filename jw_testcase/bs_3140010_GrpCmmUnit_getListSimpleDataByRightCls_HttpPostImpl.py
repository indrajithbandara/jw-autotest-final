...
class testcase_bs_3140010_GrpCmmUnit_getListSimpleDataByRightCls_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpCmmUnit_getListSimpleDataByRightCls(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"address":"","areaId":0,"bankNo":"","brandId":0,"businessDt":"","chainUid":"","cityId":0,"countryId":0,"createTyp":"","displayData":"","districtId":0,"email":"","fax":"","id":0,"indexNm":"","languageCd":"","languageId":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","mntFlg":"","mntUnitUid":"","orderColumn":[],"pageLength":"","pageStart":"","phone":"","provinceId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"starsId":0,"statusFlg":"","unitCd":"","unitComp":"","unitDrpt":"","unitFlg":"","unitNm":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpCmmUnit/getListSimpleDataByRightCls",jsondump_params, headers)
