...
class testcase_bs_3140010_PlfCisUnit_PlfCisUnitDel_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfCisUnit_PlfCisUnitDel(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfCisUnit/PlfCisUnitDel",jsondump_params, headers)
