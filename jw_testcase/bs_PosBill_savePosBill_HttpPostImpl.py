...
class testcase_bs_PosBill_savePosBill_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBill_savePosBill(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBill/savePosBill",jsondump_params, headers)
