...
class testcase_bs_3520010_GrpCrmCorpBlacklist_enableIdsGrpCrmCorpBlacklist_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpBlacklist_enableIdsGrpCrmCorpBlacklist(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","logAbstractInfo":"","logInfoDto":"","mainId":0,"originData":[],"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"submitData":[]}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpBlacklist/enableIdsGrpCrmCorpBlacklist",jsondump_params, headers)
