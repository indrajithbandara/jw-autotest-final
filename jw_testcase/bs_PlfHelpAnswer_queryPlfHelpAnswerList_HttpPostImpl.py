...
class testcase_bs_PlfHelpAnswer_queryPlfHelpAnswerList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpAnswer_queryPlfHelpAnswerList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"answerDrpt":"","answerId":0,"answerTyp":"","currentPage":0,"displayData":"","helpId":0,"id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","orderColumn":[],"pageSize":0,"questionId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpAnswer/queryPlfHelpAnswerList",jsondump_params, headers)
