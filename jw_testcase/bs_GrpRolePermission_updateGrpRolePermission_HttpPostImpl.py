...
class testcase_bs_GrpRolePermission_updateGrpRolePermission_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpRolePermission_updateGrpRolePermission(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpRolePermission/updateGrpRolePermission",jsondump_params, headers)
