...
class testcase_bs_PlfHelpQuestion_delIdsPlfHelpQuestion_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpQuestion_delIdsPlfHelpQuestion(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpQuestion/delIdsPlfHelpQuestion",jsondump_params, headers)
