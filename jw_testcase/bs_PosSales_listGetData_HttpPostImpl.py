...
class testcase_bs_PosSales_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosSales_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"acctCd":"","acctId":0,"autoProjectFlg":"","chainUid":"","discountFlg":"","discountRate":0,"displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","maxPersonNum":0,"memo":"","orderColumn":[],"pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesCd":"","salesId":0,"salesNm":"","salesTyp":"","serviceDiscountFlg":"","serviceFlg":"","serviceRate":0,"unitUid":"","validFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosSales/listGetData",jsondump_params, headers)
