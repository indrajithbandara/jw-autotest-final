...
class testcase_bs_GrpCmmOption_saveGrpCmmOption_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCmmOption_saveGrpCmmOption(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCmmOption/saveGrpCmmOption",jsondump_params, headers)
