...
class testcase_bs_3140010_GrpRole_getRolePermissions_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpRole_getRolePermissions(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpRole/getRolePermissions",jsondump_params, headers)
