...
class testcase_bs_3140010_GrpCmmDepartment_queryGrpCmmDepartmentList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpCmmDepartment_queryGrpCmmDepartmentList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","currentPage":0,"deptId":0,"deptNm":"","depttypId":0,"displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","note":"","orderColumn":[],"pageSize":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpCmmDepartment/queryGrpCmmDepartmentList",jsondump_params, headers)
