...
class testcase_bs_3520010_GrpCrmCorpContactway_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpContactway_listGetData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpContactway/listGetData",jsondump_params, headers)
