...
class testcase_bs_PlfPrdtInfo_queryPlfPrdtInfoList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtInfo_queryPlfPrdtInfoList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"currentPage":0,"displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","orderColumn":[],"pageSize":0,"prdtCd":"","prdtDrpt":"","prdtId":0,"prdtName":"","prdtTyp":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtInfo/queryPlfPrdtInfoList",jsondump_params, headers)
