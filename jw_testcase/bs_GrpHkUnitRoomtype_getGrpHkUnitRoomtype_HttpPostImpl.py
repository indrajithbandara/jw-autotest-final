...
class testcase_bs_GrpHkUnitRoomtype_getGrpHkUnitRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkUnitRoomtype_getGrpHkUnitRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkUnitRoomtype/getGrpHkUnitRoomtype",jsondump_params, headers)
