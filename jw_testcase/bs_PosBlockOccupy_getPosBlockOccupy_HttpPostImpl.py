...
class testcase_bs_PosBlockOccupy_getPosBlockOccupy_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlockOccupy_getPosBlockOccupy(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlockOccupy/getPosBlockOccupy",jsondump_params, headers)
