...
class testcase_bs_PosBlock_ListGetTotal_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlock_ListGetTotal(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlock/ListGetTotal",jsondump_params, headers)
