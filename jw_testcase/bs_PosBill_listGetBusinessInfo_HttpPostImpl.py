...
class testcase_bs_PosBill_listGetBusinessInfo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBill_listGetBusinessInfo(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","hotelCd":"","hotelDt":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","pageLength":"","pageStart":"","period":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBill/listGetBusinessInfo",jsondump_params, headers)
