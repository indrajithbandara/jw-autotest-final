...
class testcase_bs_3140010_GrpUser_saveUser_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpUser_saveUser(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpUser/saveUser",jsondump_params, headers)
