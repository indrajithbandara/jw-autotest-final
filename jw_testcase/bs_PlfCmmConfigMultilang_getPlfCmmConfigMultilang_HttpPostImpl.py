...
class testcase_bs_PlfCmmConfigMultilang_getPlfCmmConfigMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmConfigMultilang_getPlfCmmConfigMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmConfigMultilang/getPlfCmmConfigMultilang",jsondump_params, headers)
