...
class testcase_bs_PosWork_queryPosWorkList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosWork_queryPosWorkList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","currentFlg":"","currentPage":0,"displayData":"","htlDate":"","id":0,"lastBillAmount":0,"lastBillNum":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","nextBillAmount":0,"nextBillNum":0,"orderColumn":[],"pageSize":0,"periodCd":"","periodFlg":"","periodId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"unitUid":"","workId":0}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosWork/queryPosWorkList",jsondump_params, headers)
