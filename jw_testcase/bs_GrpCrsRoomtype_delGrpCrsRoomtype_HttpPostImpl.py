...
class testcase_bs_GrpCrsRoomtype_delGrpCrsRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCrsRoomtype_delGrpCrsRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCrsRoomtype/delGrpCrsRoomtype",jsondump_params, headers)
