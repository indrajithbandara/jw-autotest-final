...
class testcase_bs_PlfPrdtInfo_getPlfPrdtInfo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtInfo_getPlfPrdtInfo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtInfo/getPlfPrdtInfo",jsondump_params, headers)
