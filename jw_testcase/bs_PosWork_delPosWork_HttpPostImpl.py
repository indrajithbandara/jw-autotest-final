...
class testcase_bs_PosWork_delPosWork_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosWork_delPosWork(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosWork/delPosWork",jsondump_params, headers)
