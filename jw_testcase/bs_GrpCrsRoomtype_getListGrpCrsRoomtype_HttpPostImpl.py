...
class testcase_bs_GrpCrsRoomtype_getListGrpCrsRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCrsRoomtype_getListGrpCrsRoomtype(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","combinationFlg":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","meetingroomFlg":"","orderColumn":[],"pageLength":"","pageStart":"","pseudoFlg":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"roomtypCd":"","roomtypId":0,"roomtypNm":"","shareableFlg":"","statusFlg":"","suitFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCrsRoomtype/getListGrpCrsRoomtype",jsondump_params, headers)
