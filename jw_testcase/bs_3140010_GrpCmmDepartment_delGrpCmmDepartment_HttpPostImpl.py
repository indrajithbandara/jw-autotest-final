...
class testcase_bs_3140010_GrpCmmDepartment_delGrpCmmDepartment_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpCmmDepartment_delGrpCmmDepartment(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpCmmDepartment/delGrpCmmDepartment",jsondump_params, headers)
