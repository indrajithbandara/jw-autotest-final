...
class testcase_bs_PosBlockOccupy_delPosBlockOccupy_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlockOccupy_delPosBlockOccupy(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlockOccupy/delPosBlockOccupy",jsondump_params, headers)
