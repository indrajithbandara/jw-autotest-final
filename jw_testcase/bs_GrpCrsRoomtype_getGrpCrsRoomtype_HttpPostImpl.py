...
class testcase_bs_GrpCrsRoomtype_getGrpCrsRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCrsRoomtype_getGrpCrsRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCrsRoomtype/getGrpCrsRoomtype",jsondump_params, headers)
