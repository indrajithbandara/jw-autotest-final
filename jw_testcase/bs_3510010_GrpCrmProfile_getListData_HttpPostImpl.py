...
class testcase_bs_3510010_GrpCrmProfile_getListData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfile_getListData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"currentPage":0,"displayData":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","orderColumn":{"":""},"pageSize":0,"queryBuilder":{"":""},"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""}}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfile/getListData",jsondump_params, headers)
