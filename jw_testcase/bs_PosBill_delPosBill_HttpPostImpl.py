...
class testcase_bs_PosBill_delPosBill_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBill_delPosBill(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBill/delPosBill",jsondump_params, headers)
