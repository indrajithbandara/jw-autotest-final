...
class testcase_bs_CmmBaseParam_enableCmmBaseParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmBaseParam_enableCmmBaseParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmBaseParam/enableCmmBaseParam",jsondump_params, headers)
