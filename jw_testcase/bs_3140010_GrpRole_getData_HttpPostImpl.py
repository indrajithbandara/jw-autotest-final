...
class testcase_bs_3140010_GrpRole_getData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpRole_getData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpRole/getData",jsondump_params, headers)
