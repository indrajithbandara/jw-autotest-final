...
class testcase_bs_3510010_GrpCrmProfileBlacklist_delDatas_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfileBlacklist_delDatas(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"blackIds":{"":""},"displayData":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"subIds":[]}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfileBlacklist/delDatas",jsondump_params, headers)
