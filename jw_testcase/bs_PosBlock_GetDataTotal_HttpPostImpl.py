...
class testcase_bs_PosBlock_GetDataTotal_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlock_GetDataTotal(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","hotelCd":"","hotelDt":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","period":"","requestCommonDto":{"sessionKey":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","unitUid":"","validReqDtoStatus":""},"salesId":0}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlock/GetDataTotal",jsondump_params, headers)
