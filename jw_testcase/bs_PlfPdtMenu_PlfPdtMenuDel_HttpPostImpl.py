...
class testcase_bs_PlfPdtMenu_PlfPdtMenuDel_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPdtMenu_PlfPdtMenuDel(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPdtMenu/PlfPdtMenuDel",jsondump_params, headers)
