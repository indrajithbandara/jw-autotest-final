...
class testcase_bs_GrpHkUnitRoomtype_delGrpHkUnitRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkUnitRoomtype_delGrpHkUnitRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkUnitRoomtype/delGrpHkUnitRoomtype",jsondump_params, headers)
