...
class testcase_bs_CmmPosParamMultilang_delCmmPosParamMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParamMultilang_delCmmPosParamMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParamMultilang/delCmmPosParamMultilang",jsondump_params, headers)
