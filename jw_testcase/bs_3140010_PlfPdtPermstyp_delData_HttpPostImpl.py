...
class testcase_bs_3140010_PlfPdtPermstyp_delData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfPdtPermstyp_delData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfPdtPermstyp/delData",jsondump_params, headers)
