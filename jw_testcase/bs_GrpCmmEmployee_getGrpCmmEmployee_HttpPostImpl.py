...
class testcase_bs_GrpCmmEmployee_getGrpCmmEmployee_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCmmEmployee_getGrpCmmEmployee(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCmmEmployee/getGrpCmmEmployee",jsondump_params, headers)
