...
class testcase_bs_GrpHkBaseRoomtype_delIdsGrpHkBaseRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkBaseRoomtype_delIdsGrpHkBaseRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkBaseRoomtype/delIdsGrpHkBaseRoomtype",jsondump_params, headers)
