...
class testcase_bs_3520010_GrpCrmCorpContract_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpContract_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","contractNo":"","contractRef":"","contractTypId":0,"corpNo":"","createTyp":"","currentPage":0,"displayData":"","endDt":"","fastquery":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"orderColumn":[],"pageSize":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"signDt":"","startDt":"","statusFlg":[],"subIds":[],"unitNm":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpContract/listGetData",jsondump_params, headers)
