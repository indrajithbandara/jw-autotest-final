...
class testcase_bs_3510010_GrpCrmProfileBlacklist_getListData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfileBlacklist_getListData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfileBlacklist/getListData",jsondump_params, headers)
