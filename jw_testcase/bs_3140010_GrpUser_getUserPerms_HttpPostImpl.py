...
class testcase_bs_3140010_GrpUser_getUserPerms_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpUser_getUserPerms(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpUser/getUserPerms",jsondump_params, headers)
