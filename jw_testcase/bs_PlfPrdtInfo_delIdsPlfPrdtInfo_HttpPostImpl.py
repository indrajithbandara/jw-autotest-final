...
class testcase_bs_PlfPrdtInfo_delIdsPlfPrdtInfo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtInfo_delIdsPlfPrdtInfo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtInfo/delIdsPlfPrdtInfo",jsondump_params, headers)
