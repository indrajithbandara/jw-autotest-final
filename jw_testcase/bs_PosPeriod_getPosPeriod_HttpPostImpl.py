...
class testcase_bs_PosPeriod_getPosPeriod_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosPeriod_getPosPeriod(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosPeriod/getPosPeriod",jsondump_params, headers)
