...
class testcase_bs_PlfHelpUnitConf_delPlfHelpUnitConf_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpUnitConf_delPlfHelpUnitConf(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpUnitConf/delPlfHelpUnitConf",jsondump_params, headers)
