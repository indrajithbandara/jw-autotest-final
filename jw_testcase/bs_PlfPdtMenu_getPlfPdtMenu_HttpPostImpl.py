...
class testcase_bs_PlfPdtMenu_getPlfPdtMenu_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPdtMenu_getPlfPdtMenu(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPdtMenu/getPlfPdtMenu",jsondump_params, headers)
