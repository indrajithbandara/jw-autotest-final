...
class testcase_bs_3250010_HptHkRoomRepair_saveHptHkRoomRepairNBA_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptHkRoomRepair_saveHptHkRoomRepairNBA(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptHkRoomRepair/saveHptHkRoomRepairNBA",jsondump_params, headers)
