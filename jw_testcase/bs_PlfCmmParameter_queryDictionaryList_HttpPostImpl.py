...
class testcase_bs_PlfCmmParameter_queryDictionaryList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmParameter_queryDictionaryList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","groupCd":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","paramCd":"","paramDrpt":"","paramFlg":"","paramGrp":"","paramSubgrp":"","paramTyp":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"sortedCondition":[],"unitCd":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmParameter/queryDictionaryList",jsondump_params, headers)

            #response is HTTPResponse Object
            response = self.httpClient.getresponse()
            print response.reason
            APIreponstr = response.read()
            dbResponsejsonStr={"description":"","responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""},"resultDicts":[""]}
