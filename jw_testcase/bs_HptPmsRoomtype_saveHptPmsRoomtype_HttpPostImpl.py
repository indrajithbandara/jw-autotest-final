...
class testcase_bs_HptPmsRoomtype_saveHptPmsRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_HptPmsRoomtype_saveHptPmsRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/HptPmsRoomtype/saveHptPmsRoomtype",jsondump_params, headers)
