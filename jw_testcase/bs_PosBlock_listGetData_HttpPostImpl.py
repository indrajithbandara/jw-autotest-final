...
class testcase_bs_PosBlock_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlock_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"blockCd":"","blockFlg":"","blockId":0,"blockNm":"","blockTyp":0,"chainUid":"","delFlg":"","displayArea":0,"displayData":"","displayFlg":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","minimumArea":0,"orderColumn":[],"pageLength":"","pageStart":"","printArea":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"seatQuant":0,"serviceArea":0,"unitUid":"","validFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlock/listGetData",jsondump_params, headers)
