...
class testcase_bs_PosWork_delIdsPosWork_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosWork_delIdsPosWork(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosWork/delIdsPosWork",jsondump_params, headers)
