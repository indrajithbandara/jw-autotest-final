...
class testcase_bs_3140010_PlfCisChain_getPlfCisChain_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfCisChain_getPlfCisChain(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfCisChain/getPlfCisChain",jsondump_params, headers)
