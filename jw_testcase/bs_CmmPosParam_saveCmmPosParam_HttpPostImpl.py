...
class testcase_bs_CmmPosParam_saveCmmPosParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParam_saveCmmPosParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParam/saveCmmPosParam",jsondump_params, headers)
