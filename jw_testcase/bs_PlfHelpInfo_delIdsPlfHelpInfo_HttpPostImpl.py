...
class testcase_bs_PlfHelpInfo_delIdsPlfHelpInfo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpInfo_delIdsPlfHelpInfo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpInfo/delIdsPlfHelpInfo",jsondump_params, headers)
