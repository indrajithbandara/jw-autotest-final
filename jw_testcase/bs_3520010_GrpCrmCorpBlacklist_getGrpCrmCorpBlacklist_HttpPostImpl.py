...
class testcase_bs_3520010_GrpCrmCorpBlacklist_getGrpCrmCorpBlacklist_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpBlacklist_getGrpCrmCorpBlacklist(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpBlacklist/getGrpCrmCorpBlacklist",jsondump_params, headers)
