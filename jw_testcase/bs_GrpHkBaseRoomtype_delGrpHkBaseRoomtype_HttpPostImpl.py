...
class testcase_bs_GrpHkBaseRoomtype_delGrpHkBaseRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkBaseRoomtype_delGrpHkBaseRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkBaseRoomtype/delGrpHkBaseRoomtype",jsondump_params, headers)
