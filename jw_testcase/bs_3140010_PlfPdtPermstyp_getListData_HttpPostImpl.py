...
class testcase_bs_3140010_PlfPdtPermstyp_getListData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfPdtPermstyp_getListData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"createdBy":"","createdByCd":"","createdById":"","createdDate":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","modifiedBy":"","modifiedByCd":"","modifiedById":"","modifiedDate":"","orderColumn":[],"pageLength":"","pageStart":"","permsTypId":0,"permsTypNm":"","plevel":0,"ppermstypId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":"","version":0}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfPdtPermstyp/getListData",jsondump_params, headers)
