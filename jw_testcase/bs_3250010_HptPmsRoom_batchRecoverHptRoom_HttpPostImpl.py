...
class testcase_bs_3250010_HptPmsRoom_batchRecoverHptRoom_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsRoom_batchRecoverHptRoom(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsRoom/batchRecoverHptRoom",jsondump_params, headers)
