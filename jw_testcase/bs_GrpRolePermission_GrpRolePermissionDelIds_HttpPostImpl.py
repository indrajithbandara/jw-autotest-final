...
class testcase_bs_GrpRolePermission_GrpRolePermissionDelIds_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpRolePermission_GrpRolePermissionDelIds(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpRolePermission/GrpRolePermissionDelIds",jsondump_params, headers)
