...
class testcase_bs_3250010_HptPmsRoom_recoverHptRoom_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsRoom_recoverHptRoom(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsRoom/recoverHptRoom",jsondump_params, headers)
