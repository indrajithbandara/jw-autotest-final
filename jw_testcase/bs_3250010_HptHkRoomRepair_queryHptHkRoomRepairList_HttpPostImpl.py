...
class testcase_bs_3250010_HptHkRoomRepair_queryHptHkRoomRepairList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptHkRoomRepair_queryHptHkRoomRepairList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","completeDt":"","completeFlg":"","completeRemarks":"","completeUserId":0,"completeUsernm":"","currentPage":0,"displayData":"","endDt":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","orderColumn":[],"pageSize":0,"repairTyp":"","repairTyps":[],"repairrsnId":0,"repairrsnRemarks":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"returnSts":"","roomNum":"","startDt":"","statusFlg":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptHkRoomRepair/queryHptHkRoomRepairList",jsondump_params, headers)
