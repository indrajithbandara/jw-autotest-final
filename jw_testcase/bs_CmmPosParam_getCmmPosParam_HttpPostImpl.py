...
class testcase_bs_CmmPosParam_getCmmPosParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParam_getCmmPosParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParam/getCmmPosParam",jsondump_params, headers)
