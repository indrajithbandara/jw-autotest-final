...
class testcase_bs_PlfHelpUnitConf_delIdsPlfHelpUnitConf_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpUnitConf_delIdsPlfHelpUnitConf(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpUnitConf/delIdsPlfHelpUnitConf",jsondump_params, headers)
