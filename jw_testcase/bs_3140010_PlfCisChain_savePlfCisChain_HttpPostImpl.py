...
class testcase_bs_3140010_PlfCisChain_savePlfCisChain_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfCisChain_savePlfCisChain(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfCisChain/savePlfCisChain",jsondump_params, headers)

            #response is HTTPResponse Object
            response = self.httpClient.getresponse()
            print response.reason
            APIreponstr = response.read()
            dbResponsejsonStr={"responseCommonDto":{"errorLevel":"","lans":"","message":"","resultCode":"","sessionKey":"","token":"","tracerId":"","userUid":""},"submitData":{"chainCd":"","chainDrpt":"","chainFlg":"","chainNm":"","chainStatus":"","chainUid":"","createdBy":"","createdByCd":"","createdByUid":"","createdDate":"","createdUnitCd":"","createdUnitUid":"","custCd":"","id":0,"memo":"","modifiedBy":"","modifiedByCd":"","modifiedByUid":"","modifiedDate":"","modifiedUnitCd":"","modifiedUnitUid":"","parentEntityLock":"","plfCisChainSubDto":{},"seckey":"","seq":0,"version":0}}
