...
class testcase_bs_GrpUserrole_getGrpUserrole_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpUserrole_getGrpUserrole(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpUserrole/getGrpUserrole",jsondump_params, headers)
