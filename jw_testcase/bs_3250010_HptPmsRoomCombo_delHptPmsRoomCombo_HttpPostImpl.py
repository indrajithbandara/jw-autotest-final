...
class testcase_bs_3250010_HptPmsRoomCombo_delHptPmsRoomCombo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsRoomCombo_delHptPmsRoomCombo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsRoomCombo/delHptPmsRoomCombo",jsondump_params, headers)
