...
class testcase_bs_PlfCmmParameter_getPlfCmmParameter_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmParameter_getPlfCmmParameter(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmParameter/getPlfCmmParameter",jsondump_params, headers)
