...
import generateNewCodeForFails
import os
import shutil
from jw_testcase import generateNewCodeForFails
...
if __name__ == '__main__':
    ...
    for inter_row in interdef_result:
        ...
        generateNewCodeForFails.httpPostApiMethod(inter_name,inter_url,requestjson,responsejson,inter_type,jw_interface_reqip,jw_interface_reqport,inter_chinaname)
    ...
    jwbase_test_report_dir=os.path.join(os.path.dirname(os.getcwd()),"test-report","jwbase_interface_testlogic_report.html")
    ...
    htmlRunner= HTMLTestRunner.HTMLTestRunner(stream=fp,title=u'CloudWisdom_InterfaceAPITestReport_业务异常和逻辑错误报告',description=u"众荟慧云接口用例执行情况 by 201702 softwareluke")
