...
class testcase_bs_3250010_HptPmsRoom_batchCleanHptRoom_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsRoom_batchCleanHptRoom(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsRoom/batchCleanHptRoom",jsondump_params, headers)
