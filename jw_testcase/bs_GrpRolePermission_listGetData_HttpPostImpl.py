...
class testcase_bs_GrpRolePermission_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpRolePermission_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","dir":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","orderColumn":"","pageLength":"","pageStart":"","permsCd":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"roleUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpRolePermission/listGetData",jsondump_params, headers)
