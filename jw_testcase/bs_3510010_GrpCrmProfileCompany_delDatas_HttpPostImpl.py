...
class testcase_bs_3510010_GrpCrmProfileCompany_delDatas_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfileCompany_delDatas(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfileCompany/delDatas",jsondump_params, headers)
