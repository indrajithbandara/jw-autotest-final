...
class testcase_bs_PlfCmmConfig_savePlfCmmConfig_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmConfig_savePlfCmmConfig(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmConfig/savePlfCmmConfig",jsondump_params, headers)
