...
class testcase_bs_GrpRolePermission_saveGrpRolePermission_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpRolePermission_saveGrpRolePermission(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpRolePermission/saveGrpRolePermission",jsondump_params, headers)
