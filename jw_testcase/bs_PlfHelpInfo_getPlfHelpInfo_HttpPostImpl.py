...
class testcase_bs_PlfHelpInfo_getPlfHelpInfo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpInfo_getPlfHelpInfo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpInfo/getPlfHelpInfo",jsondump_params, headers)
