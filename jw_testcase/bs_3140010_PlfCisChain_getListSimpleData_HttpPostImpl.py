...
class testcase_bs_3140010_PlfCisChain_getListSimpleData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfCisChain_getListSimpleData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainCd":"","chainDrpt":"","chainFlg":"","chainNm":"","chainUid":"","custCd":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","orderColumn":[],"pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seckey":"","seq":0,"statusFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfCisChain/getListSimpleData",jsondump_params, headers)
