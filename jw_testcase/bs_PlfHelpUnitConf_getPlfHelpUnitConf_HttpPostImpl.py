...
class testcase_bs_PlfHelpUnitConf_getPlfHelpUnitConf_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpUnitConf_getPlfHelpUnitConf(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpUnitConf/getPlfHelpUnitConf",jsondump_params, headers)
