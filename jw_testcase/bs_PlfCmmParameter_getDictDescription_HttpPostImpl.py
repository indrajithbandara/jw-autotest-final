...
class testcase_bs_PlfCmmParameter_getDictDescription_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmParameter_getDictDescription(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmParameter/getDictDescription",jsondump_params, headers)
