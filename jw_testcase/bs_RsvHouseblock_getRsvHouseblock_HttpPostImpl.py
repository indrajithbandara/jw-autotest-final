...
class testcase_bs_RsvHouseblock_getRsvHouseblock_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvHouseblock_getRsvHouseblock(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvHouseblock/getRsvHouseblock",jsondump_params, headers)
