...
class testcase_bs_GrpUserrole_GrpUserroleDel_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpUserrole_GrpUserroleDel(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpUserrole/GrpUserroleDel",jsondump_params, headers)
