...
class testcase_bs_3510010_GrpCrmProfileCertificate_updData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfileCertificate_updData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfileCertificate/updData",jsondump_params, headers)
