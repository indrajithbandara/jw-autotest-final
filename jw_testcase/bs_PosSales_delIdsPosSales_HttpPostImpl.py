...
class testcase_bs_PosSales_delIdsPosSales_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosSales_delIdsPosSales(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosSales/delIdsPosSales",jsondump_params, headers)
