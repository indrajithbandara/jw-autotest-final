...
class testcase_bs_PlfHelpQuestion_savePlfHelpQuestion_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpQuestion_savePlfHelpQuestion(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpQuestion/savePlfHelpQuestion",jsondump_params, headers)
