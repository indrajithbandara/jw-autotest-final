...
class testcase_bs_3140010_PlfPdtPermstyp_delDatas_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfPdtPermstyp_delDatas(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfPdtPermstyp/delDatas",jsondump_params, headers)
