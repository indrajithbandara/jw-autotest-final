...
class testcase_bs_PlfPdtMenu_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPdtMenu_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"createdBy":"","createdByCd":"","createdByUid":"","createdDate":"","createdUnitCd":"","createdUnitUid":"","displayData":"","firstMenuId":0,"id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","menuCd":"","menuId":0,"menuNm":"","menuUrl":"","modifiedBy":"","modifiedByCd":"","modifiedByUid":"","modifiedDate":"","modifiedUnitCd":"","modifiedUnitUid":"","orderColumn":[],"pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"rightCls":"","secondMenuId":0,"seq":0,"statusFlg":"","sysid":"","version":0}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPdtMenu/listGetData",jsondump_params, headers)
