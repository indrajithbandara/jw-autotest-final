...
class testcase_bs_GrpUserrole_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpUserrole_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","dir":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","orderColumn":"","pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"roleUid":"","userUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpUserrole/listGetData",jsondump_params, headers)
