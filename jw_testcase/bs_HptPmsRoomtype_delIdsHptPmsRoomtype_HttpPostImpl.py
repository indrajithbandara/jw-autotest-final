...
class testcase_bs_HptPmsRoomtype_delIdsHptPmsRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_HptPmsRoomtype_delIdsHptPmsRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/HptPmsRoomtype/delIdsHptPmsRoomtype",jsondump_params, headers)
