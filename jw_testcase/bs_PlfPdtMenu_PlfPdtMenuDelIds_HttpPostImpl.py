...
class testcase_bs_PlfPdtMenu_PlfPdtMenuDelIds_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPdtMenu_PlfPdtMenuDelIds(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPdtMenu/PlfPdtMenuDelIds",jsondump_params, headers)
