...
class testcase_bs_3140010_GrpUser_delUser_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpUser_delUser(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpUser/delUser",jsondump_params, headers)
