...
class testcase_bs_PlfPrdtSale_delPlfPrdtSale_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtSale_delPlfPrdtSale(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtSale/delPlfPrdtSale",jsondump_params, headers)
