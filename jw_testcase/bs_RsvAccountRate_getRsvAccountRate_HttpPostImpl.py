...
class testcase_bs_RsvAccountRate_getRsvAccountRate_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccountRate_getRsvAccountRate(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccountRate/getRsvAccountRate",jsondump_params, headers)
