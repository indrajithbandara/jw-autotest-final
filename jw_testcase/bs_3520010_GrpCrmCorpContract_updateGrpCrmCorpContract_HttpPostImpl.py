...
class testcase_bs_3520010_GrpCrmCorpContract_updateGrpCrmCorpContract_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpContract_updateGrpCrmCorpContract(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpContract/updateGrpCrmCorpContract",jsondump_params, headers)
