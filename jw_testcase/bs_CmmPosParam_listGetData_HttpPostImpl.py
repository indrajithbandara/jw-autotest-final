...
class testcase_bs_CmmPosParam_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParam_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","note":"","orderColumn":[],"pageLength":"","pageStart":"","paramDrpt":"","paramId":0,"paramTyp":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"seq":0,"statusFlg":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParam/listGetData",jsondump_params, headers)
