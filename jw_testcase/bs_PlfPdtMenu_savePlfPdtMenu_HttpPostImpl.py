...
class testcase_bs_PlfPdtMenu_savePlfPdtMenu_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPdtMenu_savePlfPdtMenu(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPdtMenu/savePlfPdtMenu",jsondump_params, headers)
