...
class testcase_bs_3520010_GrpCrmCorpBlacklist_enableGrpCrmCorpBlacklist_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpBlacklist_enableGrpCrmCorpBlacklist(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpBlacklist/enableGrpCrmCorpBlacklist",jsondump_params, headers)
