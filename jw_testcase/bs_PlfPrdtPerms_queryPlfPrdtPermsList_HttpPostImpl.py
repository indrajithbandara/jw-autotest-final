...
class testcase_bs_PlfPrdtPerms_queryPlfPrdtPermsList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtPerms_queryPlfPrdtPermsList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"currentPage":0,"displayData":"","id":0,"isUseContinued":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","orderColumn":[],"pageSize":0,"permsCd":"","prdtCd":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""}}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtPerms/queryPlfPrdtPermsList",jsondump_params, headers)
