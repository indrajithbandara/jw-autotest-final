...
class testcase_bs_PlfCmmConfig_delIdsPlfCmmConfig_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmConfig_delIdsPlfCmmConfig(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmConfig/delIdsPlfCmmConfig",jsondump_params, headers)
