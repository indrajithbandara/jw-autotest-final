...
class testcase_bs_PosBlock_ListGetBlock_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlock_ListGetBlock(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayArea":0,"displayData":"","hotelDt":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","open_period":"","orderColumn":[],"pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlock/ListGetBlock",jsondump_params, headers)
