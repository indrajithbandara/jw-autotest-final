...
class testcase_bs_PlfPrdtPerms_getPlfPrdtPerms_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtPerms_getPlfPrdtPerms(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtPerms/getPlfPrdtPerms",jsondump_params, headers)
