...
class testcase_bs_PlfHelpConf_delPlfHelpConf_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpConf_delPlfHelpConf(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpConf/delPlfHelpConf",jsondump_params, headers)
