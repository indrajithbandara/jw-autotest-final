...
class testcase_bs_PlfCmmConfigMultilang_savePlfCmmConfigMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmConfigMultilang_savePlfCmmConfigMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmConfigMultilang/savePlfCmmConfigMultilang",jsondump_params, headers)
