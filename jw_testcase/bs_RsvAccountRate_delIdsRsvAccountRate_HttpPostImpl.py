...
class testcase_bs_RsvAccountRate_delIdsRsvAccountRate_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccountRate_delIdsRsvAccountRate(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccountRate/delIdsRsvAccountRate",jsondump_params, headers)
