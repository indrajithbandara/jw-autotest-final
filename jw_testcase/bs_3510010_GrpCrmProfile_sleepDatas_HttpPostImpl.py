...
class testcase_bs_3510010_GrpCrmProfile_sleepDatas_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfile_sleepDatas(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfile/sleepDatas",jsondump_params, headers)
