...
class testcase_bs_PosPeriod_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosPeriod_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","delFlg":"","discountFlg":"","discountRate":0,"displayData":"","endTm":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","orderColumn":[],"pageLength":"","pageStart":"","periodCd":"","periodFlg":"","periodId":0,"periodNm":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"serviceFlg":"","serviceRate":0,"startTm":"","unitUid":"","validFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosPeriod/listGetData",jsondump_params, headers)
