...
class testcase_bs_RsvAccountRate_saveRsvAccountRate_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccountRate_saveRsvAccountRate(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccountRate/saveRsvAccountRate",jsondump_params, headers)
