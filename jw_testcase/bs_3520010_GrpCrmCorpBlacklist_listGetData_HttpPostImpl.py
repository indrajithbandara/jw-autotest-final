...
class testcase_bs_3520010_GrpCrmCorpBlacklist_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorpBlacklist_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"blklsttypId":0,"chainUid":"","corpNo":"","createTyp":"","currentPage":0,"displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"orderColumn":[],"pageSize":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":"","subIds":[]}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorpBlacklist/listGetData",jsondump_params, headers)
