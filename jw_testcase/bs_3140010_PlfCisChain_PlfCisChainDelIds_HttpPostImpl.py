...
class testcase_bs_3140010_PlfCisChain_PlfCisChainDelIds_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfCisChain_PlfCisChainDelIds(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfCisChain/PlfCisChainDelIds",jsondump_params, headers)
