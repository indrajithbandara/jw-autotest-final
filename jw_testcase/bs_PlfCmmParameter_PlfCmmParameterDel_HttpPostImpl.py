...
class testcase_bs_PlfCmmParameter_PlfCmmParameterDel_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmParameter_PlfCmmParameterDel(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmParameter/PlfCmmParameterDel",jsondump_params, headers)
