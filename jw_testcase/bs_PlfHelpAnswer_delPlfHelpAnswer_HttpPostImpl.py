...
class testcase_bs_PlfHelpAnswer_delPlfHelpAnswer_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpAnswer_delPlfHelpAnswer(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpAnswer/delPlfHelpAnswer",jsondump_params, headers)
