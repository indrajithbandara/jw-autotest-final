...
class testcase_bs_PlfHelpQuestion_queryPlfHelpQuestionList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpQuestion_queryPlfHelpQuestionList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"currentPage":0,"displayData":"","helpId":0,"id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","memo":"","orderColumn":[],"pageSize":0,"questionDrpt":"","questionId":0,"questionTyp":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"seq":0,"statusFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpQuestion/queryPlfHelpQuestionList",jsondump_params, headers)
