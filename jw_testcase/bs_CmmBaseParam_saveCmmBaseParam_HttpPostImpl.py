...
class testcase_bs_CmmBaseParam_saveCmmBaseParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmBaseParam_saveCmmBaseParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmBaseParam/saveCmmBaseParam",jsondump_params, headers)
