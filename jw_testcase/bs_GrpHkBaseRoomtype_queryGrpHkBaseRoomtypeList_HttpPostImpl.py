...
class testcase_bs_GrpHkBaseRoomtype_queryGrpHkBaseRoomtypeList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkBaseRoomtype_queryGrpHkBaseRoomtypeList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","combinationFlg":"","currentPage":0,"displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","meetingroomFlg":"","note":"","orderColumn":[],"pageSize":0,"pseudoFlg":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"roomtypCd":"","roomtypFlg":"","roomtypId":0,"roomtypNm":"","seq":0,"shareableFlg":"","statusFlg":"","suitFlg":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkBaseRoomtype/queryGrpHkBaseRoomtypeList",jsondump_params, headers)
