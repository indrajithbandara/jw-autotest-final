...
class testcase_bs_3250010_HptHkRoomRepair_batchHptHkRoomRepairComplete_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptHkRoomRepair_batchHptHkRoomRepairComplete(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptHkRoomRepair/batchHptHkRoomRepairComplete",jsondump_params, headers)
