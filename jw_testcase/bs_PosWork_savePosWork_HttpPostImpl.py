...
class testcase_bs_PosWork_savePosWork_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosWork_savePosWork(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosWork/savePosWork",jsondump_params, headers)
