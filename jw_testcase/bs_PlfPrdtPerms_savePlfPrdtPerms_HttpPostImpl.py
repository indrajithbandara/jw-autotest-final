...
class testcase_bs_PlfPrdtPerms_savePlfPrdtPerms_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtPerms_savePlfPrdtPerms(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtPerms/savePlfPrdtPerms",jsondump_params, headers)
