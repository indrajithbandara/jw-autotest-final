...
class testcase_bs_3520010_GrpCrmCorp_sleepDatas_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorp_sleepDatas(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorp/sleepDatas",jsondump_params, headers)
