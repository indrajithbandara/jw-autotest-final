...
class testcase_bs_GrpUserrole_saveGrpUserrole_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpUserrole_saveGrpUserrole(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpUserrole/saveGrpUserrole",jsondump_params, headers)
