...
class testcase_bs_RsvAccount_delRsvAccount_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccount_delRsvAccount(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccount/delRsvAccount",jsondump_params, headers)
