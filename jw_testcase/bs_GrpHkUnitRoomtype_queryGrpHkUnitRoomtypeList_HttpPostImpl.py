...
class testcase_bs_GrpHkUnitRoomtype_queryGrpHkUnitRoomtypeList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkUnitRoomtype_queryGrpHkUnitRoomtypeList(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"bedtypId":0,"chainUid":"","comboFlg":"","currentPage":0,"departureCredit":0,"displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","meetingroomFlg":"","note":"","occupancyAdultMax":0,"occupancyChildMax":0,"occupancyMax":0,"occupancyNobedMax":0,"occupancyStd":0,"orderColumn":[],"pageSize":0,"pseudoFlg":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"roomNums":0,"roomtypCd":"","roomtypFlg":"","roomtypId":0,"roomtypIds":[],"roomtypNm":"","roomtypgrpId":0,"seq":0,"shareableFlg":"","stayoverCredit":0,"suitFlg":"","touchupCredit":0,"turndownCredit":0,"unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkUnitRoomtype/queryGrpHkUnitRoomtypeList",jsondump_params, headers)
