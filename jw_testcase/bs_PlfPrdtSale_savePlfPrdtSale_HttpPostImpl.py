...
class testcase_bs_PlfPrdtSale_savePlfPrdtSale_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtSale_savePlfPrdtSale(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtSale/savePlfPrdtSale",jsondump_params, headers)
