...
class testcase_bs_CmmPosParamMultilang_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParamMultilang_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","displayData":"","id":0,"languageId":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","note":"","orderColumn":[],"pageLength":"","pageStart":"","paramDrpt":"","paramId":0,"paramTyp":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0,"statusFlg":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParamMultilang/listGetData",jsondump_params, headers)
