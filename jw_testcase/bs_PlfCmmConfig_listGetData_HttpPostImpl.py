...
class testcase_bs_PlfCmmConfig_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmConfig_listGetData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmConfig/listGetData",jsondump_params, headers)
