...
class testcase_bs_3520010_GrpCrmCorp_listGetData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3520010_GrpCrmCorp_listGetData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"blackFlg":"","childFlg":"","compNm":"","compNo":"","comptypId":0,"currentPage":0,"displayData":"","fastQuery":"","ids":[],"industryId":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","marketId":0,"nIds":[],"orderColumn":{"":""},"pageSize":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salerCd":"","sleepFlg":"","sourceId":0,"statusFlg":"","unitId":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3520010/GrpCrmCorp/listGetData",jsondump_params, headers)
