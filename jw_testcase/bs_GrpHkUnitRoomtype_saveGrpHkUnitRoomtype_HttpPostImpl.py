...
class testcase_bs_GrpHkUnitRoomtype_saveGrpHkUnitRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkUnitRoomtype_saveGrpHkUnitRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkUnitRoomtype/saveGrpHkUnitRoomtype",jsondump_params, headers)
