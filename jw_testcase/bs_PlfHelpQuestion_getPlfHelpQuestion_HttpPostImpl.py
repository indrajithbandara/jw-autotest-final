...
class testcase_bs_PlfHelpQuestion_getPlfHelpQuestion_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpQuestion_getPlfHelpQuestion(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpQuestion/getPlfHelpQuestion",jsondump_params, headers)
