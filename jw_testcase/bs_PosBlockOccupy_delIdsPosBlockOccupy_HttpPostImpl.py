...
class testcase_bs_PosBlockOccupy_delIdsPosBlockOccupy_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosBlockOccupy_delIdsPosBlockOccupy(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosBlockOccupy/delIdsPosBlockOccupy",jsondump_params, headers)
