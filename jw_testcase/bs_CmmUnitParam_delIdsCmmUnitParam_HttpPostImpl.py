...
class testcase_bs_CmmUnitParam_delIdsCmmUnitParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmUnitParam_delIdsCmmUnitParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmUnitParam/delIdsCmmUnitParam",jsondump_params, headers)
