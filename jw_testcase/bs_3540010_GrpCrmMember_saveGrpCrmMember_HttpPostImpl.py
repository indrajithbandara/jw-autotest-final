...
class testcase_bs_3540010_GrpCrmMember_saveGrpCrmMember_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3540010_GrpCrmMember_saveGrpCrmMember(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3540010/GrpCrmMember/saveGrpCrmMember",jsondump_params, headers)
