...
class testcase_bs_PlfHelpConf_getPlfHelpConf_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpConf_getPlfHelpConf(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpConf/getPlfHelpConf",jsondump_params, headers)
