...
class testcase_bs_3510010_GrpCrmProfileCertificate_getListData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfileCertificate_getListData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"currentPage":0,"displayData":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","mainId":0,"orderColumn":{"":""},"pageSize":0,"queryBuilder":{"query":"","subIds":[],"typFlg":""},"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""}}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfileCertificate/getListData",jsondump_params, headers)
