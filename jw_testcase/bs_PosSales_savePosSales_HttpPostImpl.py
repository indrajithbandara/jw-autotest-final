...
class testcase_bs_PosSales_savePosSales_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosSales_savePosSales(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosSales/savePosSales",jsondump_params, headers)
