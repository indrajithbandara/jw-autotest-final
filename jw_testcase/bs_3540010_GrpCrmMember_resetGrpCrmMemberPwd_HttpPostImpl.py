...
class testcase_bs_3540010_GrpCrmMember_resetGrpCrmMemberPwd_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3540010_GrpCrmMember_resetGrpCrmMemberPwd(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3540010/GrpCrmMember/resetGrpCrmMemberPwd",jsondump_params, headers)
