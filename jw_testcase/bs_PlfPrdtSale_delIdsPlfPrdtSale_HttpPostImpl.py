...
class testcase_bs_PlfPrdtSale_delIdsPlfPrdtSale_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfPrdtSale_delIdsPlfPrdtSale(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfPrdtSale/delIdsPlfPrdtSale",jsondump_params, headers)
