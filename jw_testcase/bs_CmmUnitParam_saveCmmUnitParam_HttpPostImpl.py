...
class testcase_bs_CmmUnitParam_saveCmmUnitParam_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmUnitParam_saveCmmUnitParam(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmUnitParam/saveCmmUnitParam",jsondump_params, headers)
