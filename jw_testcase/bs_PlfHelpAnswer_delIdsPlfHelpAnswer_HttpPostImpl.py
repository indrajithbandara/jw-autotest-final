...
class testcase_bs_PlfHelpAnswer_delIdsPlfHelpAnswer_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpAnswer_delIdsPlfHelpAnswer(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpAnswer/delIdsPlfHelpAnswer",jsondump_params, headers)
