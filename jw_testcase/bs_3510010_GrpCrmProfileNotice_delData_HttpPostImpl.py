...
class testcase_bs_3510010_GrpCrmProfileNotice_delData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfileNotice_delData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfileNotice/delData",jsondump_params, headers)
