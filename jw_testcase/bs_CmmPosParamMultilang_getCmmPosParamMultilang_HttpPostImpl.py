...
class testcase_bs_CmmPosParamMultilang_getCmmPosParamMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParamMultilang_getCmmPosParamMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParamMultilang/getCmmPosParamMultilang",jsondump_params, headers)
