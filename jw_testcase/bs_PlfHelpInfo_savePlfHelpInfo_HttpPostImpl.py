...
class testcase_bs_PlfHelpInfo_savePlfHelpInfo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpInfo_savePlfHelpInfo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpInfo/savePlfHelpInfo",jsondump_params, headers)
