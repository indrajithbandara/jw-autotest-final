...
class testcase_bs_GrpCmmOption_delGrpCmmOption_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCmmOption_delGrpCmmOption(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCmmOption/delGrpCmmOption",jsondump_params, headers)
