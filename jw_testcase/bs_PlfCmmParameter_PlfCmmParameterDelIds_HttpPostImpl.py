...
class testcase_bs_PlfCmmParameter_PlfCmmParameterDelIds_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfCmmParameter_PlfCmmParameterDelIds(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfCmmParameter/PlfCmmParameterDelIds",jsondump_params, headers)
