...
class testcase_bs_RsvAccount_updateRsvAccount_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccount_updateRsvAccount(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccount/updateRsvAccount",jsondump_params, headers)
