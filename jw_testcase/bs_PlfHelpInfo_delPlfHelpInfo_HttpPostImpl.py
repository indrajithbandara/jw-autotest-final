...
class testcase_bs_PlfHelpInfo_delPlfHelpInfo_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PlfHelpInfo_delPlfHelpInfo(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PlfHelpInfo/delPlfHelpInfo",jsondump_params, headers)
