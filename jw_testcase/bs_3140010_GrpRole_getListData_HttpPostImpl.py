...
class testcase_bs_3140010_GrpRole_getListData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpRole_getListData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"chainUid":"","displayData":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","orderColumn":[],"pageLength":"","pageStart":"","permissionWithTypInfo":[""],"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"rightCls":"","roleNm":"","roleUid":"","statusFlg":"","unitUid":""}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpRole/getListData",jsondump_params, headers)
