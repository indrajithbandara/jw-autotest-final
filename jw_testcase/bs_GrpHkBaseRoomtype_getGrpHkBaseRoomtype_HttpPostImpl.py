...
class testcase_bs_GrpHkBaseRoomtype_getGrpHkBaseRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpHkBaseRoomtype_getGrpHkBaseRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpHkBaseRoomtype/getGrpHkBaseRoomtype",jsondump_params, headers)
