...
class testcase_bs_CmmPosParamMultilang_saveCmmPosParamMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParamMultilang_saveCmmPosParamMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParamMultilang/saveCmmPosParamMultilang",jsondump_params, headers)
