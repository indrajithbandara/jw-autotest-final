...
class testcase_bs_CmmPosParamMultilang_delIdsCmmPosParamMultilang_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_CmmPosParamMultilang_delIdsCmmPosParamMultilang(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/CmmPosParamMultilang/delIdsCmmPosParamMultilang",jsondump_params, headers)
