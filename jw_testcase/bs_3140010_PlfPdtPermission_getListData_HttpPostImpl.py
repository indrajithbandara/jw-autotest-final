...
class testcase_bs_3140010_PlfPdtPermission_getListData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_PlfPdtPermission_getListData(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"createdBy":"","createdByCd":"","createdById":"","createdDate":"","displayData":"","funcUrl":"","id":0,"logAbstractInfo":"","logDiffer":[],"logInfoDto":"","modifiedBy":"","modifiedByCd":"","modifiedById":"","modifiedDate":"","orderColumn":[],"pageLength":"","pageStart":"","permsCd":"","permsDrpt":"","permsFlg":"","permsNm":"","permsTypId":0,"requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"rightCls":"","seq":0,"statusFlg":"","sysFlg":"","sysid":"","version":0}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/PlfPdtPermission/getListData",jsondump_params, headers)
