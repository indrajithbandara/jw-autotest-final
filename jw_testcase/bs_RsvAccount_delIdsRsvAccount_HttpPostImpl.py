...
class testcase_bs_RsvAccount_delIdsRsvAccount_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_RsvAccount_delIdsRsvAccount(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/RsvAccount/delIdsRsvAccount",jsondump_params, headers)
