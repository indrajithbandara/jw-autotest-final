...
class testcase_bs_3140010_GrpUser_initSave_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3140010_GrpUser_initSave(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3140010/GrpUser/initSave",jsondump_params, headers)
