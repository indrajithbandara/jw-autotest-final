...
class testcase_bs_3510010_GrpCrmProfileCertificate_delData_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3510010_GrpCrmProfileCertificate_delData(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3510010/GrpCrmProfileCertificate/delData",jsondump_params, headers)
