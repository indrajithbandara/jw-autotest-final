...
class testcase_bs_PosPeriod_listGetPeriod_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_PosPeriod_listGetPeriod(self):
            print "The InterfaceApi POST Request staring............................"
            params ={"displayData":"","hotelCd":"","logAbstractInfo":"","logDiffer":[],"logInfoDto":"","pageLength":"","pageStart":"","requestCommonDto":{"sessionKey":"","sourceNm":"","sysTypeName":"","token":"","tokenStatus":"","tracerId":"","tracerIdVersion":"","unitUid":"","userUid":"","validReqDtoStatus":""},"salesId":0}
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/PosPeriod/listGetPeriod",jsondump_params, headers)
