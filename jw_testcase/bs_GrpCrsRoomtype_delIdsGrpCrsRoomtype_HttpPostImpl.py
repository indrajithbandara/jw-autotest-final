...
class testcase_bs_GrpCrsRoomtype_delIdsGrpCrsRoomtype_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_GrpCrsRoomtype_delIdsGrpCrsRoomtype(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/GrpCrsRoomtype/delIdsGrpCrsRoomtype",jsondump_params, headers)
