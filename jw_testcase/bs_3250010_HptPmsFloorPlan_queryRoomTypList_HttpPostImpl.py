...
class testcase_bs_3250010_HptPmsFloorPlan_queryRoomTypList_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsFloorPlan_queryRoomTypList(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsFloorPlan/queryRoomTypList",jsondump_params, headers)
