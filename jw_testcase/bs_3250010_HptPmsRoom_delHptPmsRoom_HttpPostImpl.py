...
class testcase_bs_3250010_HptPmsRoom_delHptPmsRoom_httppostImpl(unittest.TestCase):
    def setUp(self):
    ...
    def test_bs_3250010_HptPmsRoom_delHptPmsRoom(self):
            ...
            self.httpClient.request("POST", "/3160001RA-1.0.0-SNAPSHOT/bs/3250010/HptPmsRoom/delHptPmsRoom",jsondump_params, headers)
