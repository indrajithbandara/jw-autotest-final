...
zipfiledirfile = '/opt/javawars/html5demo.zip'  #Ҫ��ѹ���ļ�
...
if os.path.isfile(zipfiledirfile): 
    ...
    message = "Sorry, I cannot find the  file. ,pls create it"
    raise Exception("Sorry, I cannot find the  file. %s ")
    #sys.exit()
print "the message is ",message

if os.path.isfile(webappswar): 
    message = 'OK, the "%s" file exists.',current_datetime
    pass
else:
    message = "Sorry, I cannot find the  file.  ,pls create it"
...
os.system("unzip -o -d  %s %s" %(zipfiledirfile,ngnixTargetDir))
